  ...
  return (
    <header className='sticky top-0 z-50 grid grid-cols-3 shadow-md bg-white p-5 md:px-10'>
        ...
        <div className='flex items-center rounded-full py-2 md:border-2 md:shadow-sm'>
          <input value={searchInput} onChange={(e)=>setSearchInput(e.target.value)} type="text" placeholder={placeholder || 'Start your search'} className='pl-5 bg-transparent outline-none flex-grow text-sm text-gray-400'></input>
